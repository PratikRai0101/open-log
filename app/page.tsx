      ...
      <main className="pt-24">
        ...
        <section className="relative px-6 pt-12 pb-24">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-white leading-tight max-w-4xl mx-auto">
              Stop writing manual
              <br />
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-white/90 to-white/60">release notes.</span>
            </h1>
            ...
            <div className="mt-14">
              <div className="mx-auto max-w-6xl w-full rounded-2xl border border-white/10 bg-gradient-to-b from-white/2 to-transparent p-6 backdrop-blur-md shadow-2xl">
                <div className="w-full h-56 md:h-72 lg:h-96 rounded-xl bg-[#070707] border border-white/5 flex items-center justify-center">
                  <div className="text-zinc-500">[ Product UI screenshot placeholder ]</div>
                </div>
              </div>
            </div>
          </div>
